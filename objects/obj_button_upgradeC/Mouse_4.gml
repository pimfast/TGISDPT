...
if (obj_game.cash >= cost) {
	...
	obj_game.selectedtower.attack_range += 10
	
	if (obj_game.selectedtowertype == obj_archer) {
		obj_game.selectedtower.upgradeprogressC += 1
	}
	...
	if ((obj_game.selectedtower.upgradeprogressA > 3 || obj_game.selectedtower.upgradeprogressB > 3 || obj_game.selectedtower.upgradeprogressC > 3) && (obj_game.selectedtower.upgradeprogressA >= 3) && (obj_game.selectedtower.upgradeprogressB >= 3) && (obj_game.selectedtower.upgradeprogressC >= 3)) {obj_game.selectedtower.sprite_index = spr_archer_ultimate}
